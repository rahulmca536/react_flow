import React, { Component } from "react";
 function MyReactCompoennt() {
  const [isOpen, setimporttypeModal] = React.useState(true);
  ...
  function drawer() {
    ...
    return (
      <nav className="flex fixed w-full items-center justify-between px-6 h-16 bg-white text-gray-700 border-b border-gray-200 z-10">
        <div className="flex items-center">
          <button className="mr-2" aria-label="Open Menu" onClick={()=> drawer()}>
            <svg
              fill="none"
              stroke="currentColor"
          ...
          <img src="/logos/fox-hub.png" alt="Logo" className="h-auto w-24" />
        </div>
        <div className="flex items-center">
    ...
    export default MyReactCompoennt